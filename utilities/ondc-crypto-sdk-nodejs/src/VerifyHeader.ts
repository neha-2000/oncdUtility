 ...
 const main= () =>  {
    try {
      const header =  isSignatureValid({
        header:'Signature keyId="staging.smann.in|3dfa7108-a09e-4054-84a2-77c0361a9c9d|ed25519",algorithm="ed25519",created="1705294353",expires="1705297953",headers="(created) (expires) digest",signature="m0mKyBI6Knb+32T+Tm8U/CyiWyASo59sNhMwXOrRj3gz8Plw1Du3vZWCmDkawCPNkIXfl7LfOEzEp5bVm6ikDw=="',
        body: { 
